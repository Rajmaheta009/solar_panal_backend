...
Revision ID: 26e41934d981
Revises: e392a9d48ec0
Create Date: 2024-12-22 17:40:53.396282
...
revision: str = '26e41934d981'
down_revision: Union[str, None] = 'e392a9d48ec0'
...
def upgrade() -> None:
    ...
    op.drop_constraint('pages_menu_id_fkey', 'pages', type_='foreignkey')
    op.drop_constraint('pages_content_page_id_fkey', 'pages_content', type_='foreignkey')
    op.drop_constraint('auth_user_id_fkey', 'auth_user', type_='foreignkey')

    # Drop the indexes and tables
